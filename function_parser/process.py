...
class DataProcessor:
    ...
    def process_dee(self, nwo: str, ext: str, oauth_token: str = None, branch: str = None, only_branch: bool = False) -> List[Dict[str, Any]]:
        ...
        tmp_dir = download(nwo, oauth_token, branch, only_branch)
