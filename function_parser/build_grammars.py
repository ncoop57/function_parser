...
_GRAMMARs = {
    ...
    "php": ("https://github.com/tree-sitter/tree-sitter-php.git", "tree-sitter-php", "v0.13.0"),
    "ruby": ("https://github.com/tree-sitter/tree-sitter-ruby", "tree-sitter-ruby", "v0.13.0")
}
